    ...
    for epoch in range(opt.num_epochs):
        ...
        for i, batch in enumerate(train_data):
            ...
            if opt.log_interval and not (i+1)%opt.log_interval:
                ...
                logging.info('Epoch[%d] Batch [%d]\tSpeed: %f samples/sec\trmse=%f\tlr=%f'%(
                             epoch, i, batch_size*opt.log_interval/(time.time()-btic), rmse_score,
        ...
        logging.info('[Epoch %d] training: rmse=%f'%(epoch, rmse_score))
